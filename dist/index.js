...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.castValueToType = exports.stringToValidTypeString = exports.isValidType = exports.ValidTypesArray = void 0;
exports.ValidTypesArray = ['number', 'boolean', 'object', 'string', 'null', 'delete', 'undefined'];
var isValidType = function (type) { return exports.ValidTypesArray.includes(type); };
exports.isValidType = isValidType;
var stringToValidTypeString = function (type) {
    switch (type) {
        case 'number':
            return 'number';
        case 'boolean':
...
exports.stringToValidTypeString = stringToValidTypeString;
/**
 * Casts value to type
 ...
 */
var castValueToType = function (value, type, suppressExceptions) {
    if (suppressExceptions === void 0) { suppressExceptions = false; }
    switch (type) {
        case 'number':
        ...
        case 'object':
            try {
                ...
                if (suppressExceptions)
                    ...
                    throw new Error("Value '".concat(value, "' is not a valid JSON object (").concat(err, ")"));
            }
        case 'string':
        case undefined:
            return value;
...
exports.castValueToType = castValueToType;
...
__webpack_unused_export__ = __webpack_unused_export__ = exports.MU = __webpack_unused_export__ = void 0;
var jsonValueByPath_1 = __nccwpck_require__(35);
__webpack_unused_export__ = ({ enumerable: true, get: function () { return jsonValueByPath_1.setValueByPath; } });
var jsonValueByPath_2 = __nccwpck_require__(35);
Object.defineProperty(exports, "MU", ({ enumerable: true, get: function () { return jsonValueByPath_2.getValueByPath; } }));
var castValueToType_1 = __nccwpck_require__(672);
__webpack_unused_export__ = ({ enumerable: true, get: function () { return castValueToType_1.castValueToType; } });
__webpack_unused_export__ = ({ enumerable: true, get: function () { return castValueToType_1.stringToValidTypeString; } });
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.setValueByPath = exports.getValueByPath = void 0;
/**
 ...
 */
var getValueByPath = function (obj, paths) {
    var path = paths[0];
    if (obj && obj[path] && paths.length > 1 && path) {
        return (0, exports.getValueByPath)(obj[path] ? obj[path] : null, paths.slice(1));
    }
    else {
        return obj[path];
    }
 ...
 */
var setValueByPath = function (obj, paths, value) {
    var path = paths[0];
    if (paths.length > 1) {
        obj[path] = (0, exports.setValueByPath)(typeof obj[path] !== 'object' ? {} : obj[path], paths.slice(1), value);
    }
...
// EXTERNAL MODULE: ./node_modules/@xorde-labs/ferramenta/dist/cjs/index.js
var cjs = __nccwpck_require__(39);
...
var workspace = (_a = process.env.GITHUB_WORKSPACE) !== null && _a !== void 0 ? _a : './';
var run = function () {
    var _a, _b;
    try {
        ...
        core.notice("File=".concat(file, " Property=").concat(property, " Value=").concat(value));
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(__nccwpck_require__.s = 172);
